...
import { getAIConfiguration, testAIConfiguration } from "@/lib/aiConfigurations";
...
const TestAIConfiguration: React.FC<TestAIConfigurationProps> = ({ gymId, configId }) => {
  ...
  if (isConfigLoading) {
    return <div className="flex justify-center p-8">Loading AI configuration details...</div>;
  }
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Example: "Create a sample breakfast recipe for weight loss" or "Suggest a 30-minute workout routine"
            </p>
          </div>
        </CardContent>
