  ...
  if (!data?.data || data.data.length === 0) {
    return (
      <div className="text-center p-8">
        ...
        <Button
          onClick={() => navigate(`/gyms/${gymId}/ai-configurations/create`)}
        >
          ...
          <Card key={config.id} className="overflow-hidden">
            ...
            <CardFooter className="flex justify-between pt-2">
              <Button
                ...
                size="sm"
                onClick={() =>
                  navigate(`/gyms/${gymId}/ai-configurations/${config.id}/test`)
                }
              >
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      `/gyms/${gymId}/ai-configurations/${config.id}/edit`
                    )
                  }
                >
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to delete this AI configuration?
