    ...
    return (
      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            The assessment result could not be found or hasn't been generated
            yet.
          </CardDescription>
        </CardHeader>
        <CardFooter>
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <Card className="border-green-200 bg-green-50 dark:bg-green-950/20">
        <CardHeader>
          ...
          <CardDescription>
            Your assessment has been completed and a personalized plan has been
            generated.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="py-2">
            ...
            <p className="text-muted-foreground">
              Completed on{" "}
              {new Date(result.assessment.completed_at).toLocaleDateString()}
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium">
                  {result.diet_plan.daily_calories} kcal
                </p>
              </div>
              <div className="space-y-1">
                ...
                <div className="flex items-center">
                  ...
                  <p className="font-medium">
                    {new Date(result.diet_plan.start_date).toLocaleDateString()}{" "}
                    to{" "}
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium">
                  {result.diet_plan.protein_grams}g /{" "}
                  {result.diet_plan.carbs_grams}g /{" "}
                  {result.diet_plan.fats_grams}g
                </p>
              </div>
            </div>
          </CardContent>
