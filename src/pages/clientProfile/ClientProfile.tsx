  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-primary-900">Client Profile</h1>
          <p className="text-muted-foreground">Manage client health and nutrition profile</p>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={() => navigate(`/users/${userId}/profile/edit`)}>
