  ...
  return (
    <div className="container mx-auto p-6 font-poppins">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold font-poppins text-primary-900 flex items-center">
            <Utensils className="mr-2 h-8 w-8 text-primary-600" />
            Diet Plans
          </h1>
          <p className="text-muted-foreground">
            Manage and create nutritional diet plans for clients
          </p>
        </div>
        <Button
      ...
      <Card
        className="mb-6 border border-primary shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden rounded-lg"
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {filteredPlans?.map((plan) => (
              <div
                key={plan.id}
                className="border border-primary/40 hover:border-primary rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
              >
                <DietPlanCard
                  plan={plan}
                  onDelete={() => {}}
