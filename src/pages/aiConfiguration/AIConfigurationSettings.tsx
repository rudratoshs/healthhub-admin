...
const AIConfigurationSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">AI Configuration Settings</h1>
        <p className="text-muted-foreground">
          Manage and configure AI models for your gym's assessments and diet plans
        </p>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            AI configurations allow you to connect to different AI providers and customize how 
            AI is used in your gym for generating meal plans, assessment analyses, and more.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>Use your own API keys for better control and cost management</li>
              <li>Choose between different AI providers (OpenAI, Anthropic, Google, etc.)</li>
