...
const WebAssessmentStart: React.FC = () => {
  const { status, statusLoading, resumeAssessment, loading } =
    useWebAssessment();
  const { user } = useAuth();
  ...
  const handleAssessmentStart = (sessionId?: number) => {
    console.log('sessionid',sessionId)
    if (sessionId) {
      resumeAssessment(sessionId); // call API to resume
      navigate(`/web-assessment/questions?session_id=${sessionId}`);
    } else {
      navigate("/web-assessment/questions");
    }
  };
        ...
        {status?.has_active_assessment && (
          <Card className="mb-6 shadow-md">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                You have an active assessment in progress (started{" "}
            ...
            <CardFooter className="flex justify-between">
              <StartAssessmentDialog
                ...
                assessmentType={status.assessment_type}
              />
        ...
        {status?.has_completed_assessment && (
          <Card className="mb-6 shadow-md border-green-100">
            <CardHeader className="pb-3 bg-green-50 border-b border-green-100">
              ...
              <CardDescription>
                You have already completed an assessment. You can view your
                results or start a new one.
              </CardDescription>
            </CardHeader>
          ...
          !status?.has_completed_assessment && (
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Take our wellness assessment to receive a personalized health
                  and nutrition plan
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Our assessment will ask you questions about your health goals,
                  dietary preferences, and lifestyle to create a tailored plan
                  that works for you.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  ...
                  >
                    ...
                    <CardContent>
                      <p className="text-sm">
                        Quick 5-minute assessment for essential recommendations
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  >
                    ...
                    <CardContent>
                      <p className="text-sm">
                        10-minute comprehensive health and nutrition assessment
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  >
                    ...
                    <CardContent>
                      <p className="text-sm">
                        Detailed 15-minute assessment with in-depth analysis
                      </p>
                    </CardContent>
                  </Card>
                </div>
