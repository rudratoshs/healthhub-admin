      ...
      <div className="container mx-auto p-6">
        <Card className="border-red-200 shadow-lg">
          ...
          <CardContent className="pt-6">
            <p>
              There was an error loading the meal plan. The plan may not exist.
            </p>
            <Button
              variant="outline"
              className="mt-4"
  ...
  return (
    <div className="container mx-auto p-6 font-poppins">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold font-poppins text-primary-900">
            {dayOfWeek} Meal Plan
          </h1>
          <p className="text-muted-foreground">
            View and manage meals for {dayOfWeek}
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            onClick={() =>
              navigate(
                `/diet-plans/${dietPlanIdInt}/meal-plans/${mealPlanId}/edit`
              )
            }
      ...
      <MealPlanDetail
        ...
        onBack={() => navigate(`/diet-plans/${dietPlanIdInt}`)}
      />{" "}
    </div>
  );
};
